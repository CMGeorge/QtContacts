...
HEADERS += \
    ...
    QMAKE_BUNDLE_DATA = QMAKE_INFO_PLIST
    QMAKE_PROJECT_NAME = "ContactsTest"
    QMAKE_IOS_DEPLOYMENT_TARGET = 9.0
    QMAKE_TARGET_BUNDLE_PREFIX = net.reea

    team.name=DEVELOPMENT_TEAM
    team.value=JF3P2VRYST
